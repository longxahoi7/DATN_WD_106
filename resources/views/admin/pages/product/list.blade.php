    ...
    <body>
        <div class="container">
            ...
            <table class="product-table">
                <a href="{{route('admin.products.create')}}"><button class="btn add-button add-button-product">Thêm
                        mới</button></a>
                <thead>
                    <tr>
                        <th>Mã sản phẩm</th>
                ...
                <tbody id="product-list">
                    @foreach ($products as $product)
                        <tr>
                            <td>{{$product->sku}}</td>
                            <td>{{$product->name}}</td>
                            <td><img src="{{ Storage::url($product->main_image_url) }}" width="100px" height="100px"
                                    alt="Sản phẩm A"></td>
                            ...
                            <td>
                                <div class="icon-product">
                                    <a href="{{route('admin.products.detail', $product->product_id)}}"><button
                                            class="action-btn eye"><i class="fas fa-eye"></i></button></a>

                                    <a href="{{route('admin.products.edit', $product->product_id)}}"><button
                                            class="action-btn edit"><i class="fas fa-edit"></i></button></a>
                                    <!-- Form xóa -->
