    ...
    <>
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg flex">
        <div className="w-1/3 pr-6">
          ...
          <div className="mb-4">
            <label className="block text-gray-700 mb-2">Chọn tỉnh thành</label>
          ...
          <div className="mb-4">
            <label className="block text-gray-700 mb-2">Chọn cửa hàng</label>
            <select className="w-full p-2 border border-gray-300 rounded">
          ...
          <div className="mb-4">
            <div className="flex items-start mb-4">
              ...
              <div>
                <h3 className="font-bold">TORANO 02 CHÙA BỘC</h3>
                <p>Số 02, Chùa Bộc , Đống Đa, Hà Nội</p>
                <p>
                  Thời gian hoạt động: <strong>8:30 - 22:00</strong>
                </p>
                <p>
            ...
            <div className="flex items-start">
              <i className="fas fa-map-marker-alt text-red-500 text-xl mr-2"></i>
              <div>
                <h3 className="font-bold">TORANO 31 YÊN LÃNG</h3>
